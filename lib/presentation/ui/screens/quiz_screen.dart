...
class QuizPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (quizProvider.questionList.isEmpty) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: CustomAppBar(
            ontap: () {
              quizProvider.moveToPreviousQuestion(context);
            },
            title: "Quiz",
        ...
        body: SafeArea(
          child: ListView(
            children: [
              ...
              _questionWidget(quizProvider),
              const SizedBox(
                height: 47,
              ),
              _answerList(quizProvider, context),
            ],
          ),
        ),
      ),
  ...
  Widget _questionWidget(QuizProvider quizProvider) {
    return Padding(
  ...
  Widget _answerList(QuizProvider quizProvider, BuildContext context) {
    return Container(
  ...
  Widget _answerButton(
      QuizProvider quizProvider, Answer answer, BuildContext context) {
  ...
  void _resultPage(QuizProvider quizProvider, BuildContext context) {
    final bool isPassed = quizProvider.isQuizPassed();
    final String score = quizProvider.score.toString();

    Future.delayed(Duration.zero, () {
      Navigator.pushNamed(context, "result_page_quiz",
